...
```
python3 perf_client.py --mode rps --base-url http://127.0.0.1:7001 --workload-file taskset/workload_nq.json --model llama3-70b --stream true --rag true --injection-type kvcache --requests 30 --rps 0.1 --seed 118 --monitor-gpu
```
