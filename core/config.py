...
# Instance资源监控（demo默认关闭；通过 --resource-monitor 或 INSTANCE_RESOURCE_MONITOR_ENABLE=1 启用）
INSTANCE_RESOURCE_MONITOR_ENABLE = False
...
INSTANCE_RESOURCE_AGENT_SAMPLE_INTERVAL_MS = 33
INSTANCE_RESOURCE_AGENT_START_TIMEOUT_S = 60.0
INSTANCE_RESOURCE_REPORT_ENABLE = False
INSTANCE_RESOURCE_REPORT_HZ = 30.0
INSTANCE_RESOURCE_REPORT_INTERVAL_MS = 33
