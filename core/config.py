...
SCHEDULER_DEFAULT_STRATEGY = "round_robin"
SCHEDULER_CACHEROUTE_KDN_QPS_OVERLOAD_TH = 0.0
SCHEDULER_CACHEROUTE_KDN_ITEMS_OVERLOAD_TH = 0
SCHEDULER_CACHEROUTE_KDN_PENDING_OVERLOAD_TH = 0
SCHEDULER_CACHEROUTE_KDN_ACTIVE_OVERLOAD_TH = 0
SCHEDULER_CACHEROUTE_KDN_QUEUE_MS_OVERLOAD_TH = 0.0
SCHEDULER_CACHEROUTE_PROXY_INFLIGHT_DELTA = 2
SCHEDULER_CACHEROUTE_PROXY_GPU_DELTA = 0.0
SCHEDULER_CACHEROUTE_AFFINITY_DECAY = 0.9
SCHEDULER_CACHEROUTE_AFFINITY_TOPK = 256
SCHEDULER_CACHEROUTE_LOG_DECISION = 1
# ====================================================================#
#                               Proxy                                 #
# ====================================================================#
...
KDN_HOST = "127.0.0.1"
KDN_PORT = 9101
KDN_NETWORK_ENABLE = False
KDN_NETWORK_BW_MB_S = 125.0
KDN_NETWORK_BATCH_WINDOW_MS = 10.0
KDN_NETWORK_FIXED_LATENCY_MS = 10.0
KDN_NETWORK_EFFICIENCY = 0.8
